...
class FileOutputTests(unittest.TestCase):
    def test_sessions_are_grouped_under_one_daily_heading(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            cronometro.append_duration(path, first_start, 10800, first_end)
            cronometro.append_duration(path, second_start, 1530, second_end)
    ...
    def test_existing_content_is_preserved(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            cronometro.append_duration(path, start, 60, end)
